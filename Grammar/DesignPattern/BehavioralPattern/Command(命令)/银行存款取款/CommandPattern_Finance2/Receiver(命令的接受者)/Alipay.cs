...
{
    public class Alipay : FinancialInstitution
    {
        /// <summary>
        /// 账号总金额
        /// </summary>
        ...
        public void MoneyIn(decimal amount)
        {
            ...
            Console.WriteLine("【支付宝】存钱：" + amount.ToString("N2") + "  当前金额是： " + GetTotalAmount().ToString("N2"));
        ...
        public void TransferIn(decimal amount)
        {
            //throw new NotImplementedException();
            this.totalAmount += amount;
            Console.WriteLine("【支付宝】转入：" + amount.ToString("N2") + "  当前金额是： " + GetTotalAmount().ToString("N2"));
